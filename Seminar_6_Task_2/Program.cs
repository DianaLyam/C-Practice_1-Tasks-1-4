...
void ResultInterpretator (double [] result,double k1, double b1, double k2, double b2)
{
    ...
    {
        Console.WriteLine($"The point of interception of lines y={k1}x+{b1} and y ={k2}x+{b2} is ({result[0]:f2}, {result[1]:f2})");
    }
}

double k1 = prompt ("Define the coefficient k1: ");
double b1 = prompt ("Define the coefficient b1: ");
double k2 = prompt ("Define the coefficient k2: ");
double b2 = prompt ("Define the coefficient b2: ");
